...
plot(time_1,func_1(:,1)/1000,'-','Color','b','LineWidth',2.2);
plot(time_2,func_2(:,1)/1000,'-','Color','r','LineWidth',2.2);

xlabel('Time (Seconds)','FontSize',20);
ylabel('Congestion Window (kB)','FontSize',20);
title('Congestion Window of TCP vs QUIC for download of X file','FontSize',22);
