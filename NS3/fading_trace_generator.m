...
title('Fading Trace for Pedestrian Mobility (EPA 3kmph)','FontSize',22);

ylabel('RB Index','FontSize',20);
xlabel('Time (ms)','FontSize',20);
zlabel('Amplitude (dB)','FontSize',20);
...
file = fopen(strcat('fading_trace_modified_40s_',tag,'.fad'),'at');   
